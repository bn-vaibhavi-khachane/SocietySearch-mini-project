...
export default function AddSociety({ open, onClose, onAdd }) {
  ...
  return (
    <React.Fragment>
      <Dialog
        open={open}
        onClose={handleClose}
        aria-labelledby="add-society-title"
        fullWidth
        maxWidth="sm"
      >
        <form onSubmit={handleSubmit}>
          <DialogTitle id="add-society-title">Add Society</DialogTitle>
          <DialogContent>
            <DialogContentText sx={{ mb: 2 }}>
              Add the society details below.
            </DialogContentText>
            <Stack spacing={2}>
              <TextField
                label="Society Name"
              ...
              <TextField
                ...
                onChange={handleChange}
                placeholder="https://example.com/society-image.jpg"
              ...
              <FormControl fullWidth required>
                <InputLabel id="availability-status-label">Unit Availability Status</InputLabel>
                <Select
              ...
              <FormControl fullWidth>
                <InputLabel id="unit-types-label">Available Unit Types</InputLabel>
                <Select
                  labelId="unit-types-label"
